...
import { DirectMessage } from "@prisma/client"; // Importing Message type from Prisma client for type safety
...
export async function GET(
    ...
    try {
        ...
        const conversationId = searchParams.get("conversationId"); // Get the channelId parameter from the search parameters
        ...
        let messages: DirectMessage[] = []; // Initialize an array to store fetched messages
        ...
        console.log("[DIRECT_MESSAGES_GET]", error); // Log error for debugging purposes
